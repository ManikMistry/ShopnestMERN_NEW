...
async function findProductById(id) {
  ...
  if (!product) {
    throw new Error("Product not found wiht id " + id);
  }
  return product;
}

// Get all products to perform sorting the products
async function getAllProducts(reqQuery) {
  ...
  // sort by min to high and high to min
  if (sort) {
...
// create multile products in database
